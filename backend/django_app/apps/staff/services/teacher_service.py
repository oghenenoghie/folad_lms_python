...
def create_teacher(*, staff: Staff, actor, **fields) -> Teacher:
    return Teacher.objects.create(
        organization=staff.organization, staff=staff, created_by=actor, updated_by=actor, **fields
    )


def update_teacher(*, teacher: Teacher, actor, **fields) -> Teacher:
...
def delete_teacher(*, teacher: Teacher, actor) -> None:
